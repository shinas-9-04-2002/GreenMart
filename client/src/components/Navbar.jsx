...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            <Link to={"/"}>
                <h1 className="text-3xl font-bold text-green-600">GreenMart</h1>
            </Link>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {user?(
                  ...
                  <div className="relative group">
                    ...
                    <ul className="hidden  group-hover:block absolute top-10 right-0 bg-white shadow-md border border-gray-200 py-2 w-30 z-40 text-sm">
                      <li onClick={()=>{
                        navigate('/my-orders')
